namespace Soundger.View.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.settingsItem = new Soundger.View.SideMenuItemControl();
            this.filesItem = new Soundger.View.SideMenuItemControl();
            this.myItem = new Soundger.View.SideMenuItemControl();
            ...
            this.mainItem = new Soundger.View.SideMenuItemControl();
            this.smp_2 = new System.Windows.Forms.Panel();
            this.profileItem = new Soundger.View.SideMenuItemControl();
